            ...
            <div class="col-sm-4 text-left">
                ...
                <div class="row padding-top">
                    ...
                    <div class="col-sm-8 padding-bottom">
                        ...
                        {{ Form::label('Address') }}
                        {{ Form::text('co_address1','VENICE DI IRIS Shopping Plaza, 1/242 Watcharaphon Road, Khwaeng Tha Raeng, Khet Bang Khen',
                                        array(
                                                    'class' => 'form-control input-lg',
                                                    'style' => 'border: 1px solid #ccc;',
                                                    'id' => 'co_address1',
                        ...
                        {{ Form::textarea('co_instruction','in case you have specific needs about dimensions, or about the delivery location, please let us know. we will call you for confirmation of specs.',                                        array(
                                                    'class' => 'form-control input-lg',
                                                    'style' => 'border: 1px solid #ccc;',
                                                    'id' => 'co_instruction',
...
<!--                            <br> We support one of the following on-line payment methods. You can also pay off-line via bank transfer. <br>
        ...
        <a href="./index">Return to the shop</a>
