    ...
    <div class="container">        
        ...
        <div class="row">
            <div class="col-sm-4 text-left">
                ...
                <!-- Container -->
                {{ Form::hidden('checkout_type', "FIRST" ) }}
...
<!--                            <br> We support one of the following on-line payment methods. You can also pay off-line via bank transfer. <br>
                            <img src="{{ asset('../../thairattan2') }}/assets/cards.png" style="max-width:280px;" alt="Cards">-->
                        </aside>
