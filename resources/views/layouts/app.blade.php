    ...
    <div id="app">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="vira-card" style="max-height: 300px;">
                            <div class="vira-card-header">
                                <span class="fa fa-phone" aria-hidden="true"></span> <img src="{{ asset('../../thairattan2') }}/assets/line-grey.png" style="width:50px;">
                            </div>
                            <div class="vira-card-content">
                                <h3>Phone / Line</h3>
                                <p>                                    
                                    +66 098 797 4129 ( Thai )<br>+66 098 797 5280 ( English )<br> Line Id: thairattan-th<br>Line Id: thairattan-en
                                </p>
                            </div>
        ...
        <footer class="footer">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <p class="cite">  <img style="height:130px;" src="{{ asset('../../thairattan2') }}/assets/logo_white3.png"> <br> Handcrafted with <span class="fa fa-heart"></span> and Passion.<br>© Thai Rattan - 2016<br><br><a href="https://www.facebook.com/thairattan" target="_blank"><i class="fa fa-facebook-square" style="font-size: 30px;"></i></a><br></p>
                    </div>
                </div>
            </div>
        </footer>
