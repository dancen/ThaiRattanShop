    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right" style="line-height: 60px; margin-top: 10px;">
                ...
                <!--                        <li class="menu-item-img">
                                            <span class="language">
                                                <a class="page-scroll" href="./"><img class="langflag" src="{{ asset('../../thairattan2') }}/assets/thai-flag.jpg"></a>
                                                <img style="opacity: 0.5;" class="langflag" src="{{ asset('../../thairattan2') }}/assets/uk-flag.jpg">
                                            </span> 
                                        </li>-->
