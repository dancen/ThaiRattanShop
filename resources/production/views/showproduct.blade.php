...
<section id="thai-rattan-must-have" class="about section">           
    ...
    <div class="container">
        ...
        <img src="{{ asset('../..') }}/assets/products/{{ $product->big_image }}" class="img-responsive" alt="Natura Rattan {{ $product->big_image }}">
        ...
        <div class="row">
            ...
            <div class="col-sm-6 text-left" style="padding-left:30px;">  
                ...
                <div class="hidden-xs">Not sure about colors? <a href="{{ route("color-tester") }}" target="_blank">Try our color tester!</a></div>
            ...
            <div class="col-sm-6 text-left">
                ...
                <div class="row">
                    <div class="col-sm-12 text-left">
                        <span class="pull-left"> <img src="{{ asset('../..') }}/assets/products/{{ $product->small_image }}" style="max-height:100px;" alt=""> </span>
                    </div>
                </div>
            ...
            <div class="col-sm-12 text-left">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 text-left">
                        ...
                        <a class="btn btn-lg btn-info" href="{{ asset('../..') }}/en/subscribe.html">Get your Coupon Now!</a><br><br>
