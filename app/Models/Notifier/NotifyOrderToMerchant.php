...
/**
 * Description of NotifyOrderToMerchant
 *
 * @author dan
 */
class NotifyOrderToMerchant extends Notifier implements NotifyOrderInterface {
    ...
    private function buildAddress() {
        ...
        $message .= "<table><tr>";
        $message .= "<td style='width:200px;'>First Name: <br><hr/></td><td><b>" . $this->order->first_name . "</b><br><hr/></td></tr><tr>";
        $message .= "<td style='width:200px;'>Last Name: <br><hr/></td><td><b>" . $this->order->last_name . "</b><br><hr/></td></tr><tr>";
